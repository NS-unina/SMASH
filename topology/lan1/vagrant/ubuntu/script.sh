...
ip_address=$(find_free_ip2 "$subnet")
...
config_string="    deploy_honeypot2(config, \"$vm_name\", \"ubuntu/focal64\", \"512\",\"shared\", 22, 3209,\"ssh\", \"$tap_name\", \"$mac_tap\", \"$ip_address\", $routes,\"$gateway\")"
