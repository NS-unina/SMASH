...
setup_vlan_interface "vlan31" "10.3.3.1/24" "8a:ae:02:40:8f:94"
setup_vlan_interface "vlan32" "10.3.4.1/24" "ea:6a:20:a0:96:14"
setup_vlan_interface "vlan33" "10.3.5.1/24" "ea:6a:20:a0:96:17"
...
# sudo ifconfig br1 10.1.92.106/24 up
# sudo route add default gw 10.1.92.68 br1

# #sudo ifconfig br1 10.1.1.16/24 up
# #sudo route add default gw 10.1.1.1 br1
