...
s1 = Host('s1', '10.1.3.14', '08:00:27:b6:d0:70', 27, '255.255.255.0')
s2 = Host('s2', '10.1.3.15', '08:00:27:b6:d0:71', 28, '255.255.255.0')
s3 = Host('s3', '10.1.3.16', '08:00:27:b6:d0:72', 29, '255.255.255.0')
s4 = Host('s4', '10.1.3.17', '08:00:27:b6:d0:73', 30, '255.255.255.0')
s5 = Host('s5', '10.1.3.18', '08:00:27:b6:d0:74', 31, '255.255.255.0')
s6 = Host('s6', '10.1.3.19', '08:00:27:b6:d0:75', 32, '255.255.255.0')
s7 = Host('s7', '10.1.3.20', '08:00:27:b6:d0:76', 33, '255.255.255.0')
s8 = Host('s8', '10.1.3.21', '08:00:27:b6:d0:77', 34, '255.255.255.0')
s9 = Host('s9', '10.1.3.22', '08:00:27:b6:d0:78', 35, '255.255.255.0')
s10 = Host('s10', '10.1.3.23', '08:00:27:b6:d0:79', 36, '255.255.255.0')
...
# ovs2
gw10 = Gateway('gw10', '10.1.10.1', '8a:ae:02:40:8f:93', 40, '255.255.255.0')
gw11 = Gateway('gw11', '10.1.11.1', 'ea:6a:20:a0:96:11', 41, '255.255.255.0')
