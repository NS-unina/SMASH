...
sudo hostnamectl set-hostname 'ext-heralding'

sudo apt-get update
export PATH=$PATH:/home/ubuntu/.local/bin

sudo sed -i 's/#Port 22/Port 40005/' /etc/ssh/sshd_config
...
cp /home/claudio/ubuntu/ext_heralding/heralding.yml /home/vagrant/heralding/lib/python3.8/site-packages/heralding/heralding.yml
#nohup heralding &
cp /home/claudio/ubuntu/ext_heralding/conf.sh /home/vagrant
cp /home/claudio/ubuntu/ext_heralding/start.sh /home/vagrant
...
sudo cp /home/claudio/ubuntu/ext_heralding/metricbeat.yml /etc/metricbeat/metricbeat.yml
sudo service metricbeat start
sudo systemctl enable metricbeat


sudo cp /home/claudio/ubuntu/ext_heralding/filebeat.yml /etc/filebeat/filebeat.yml
