...
class ExampleSwitch13(app_manager.RyuApp):
    ...
    def add_default_rules_br0(self, datapath):
        ...
        self.permit_tcp_dstIP_dstPORT(parser, t.heralding.get_ip_addr(), t.heralding.get_ovs_port(), 22, datapath)
    ...
    def add_default_rules_br1(self, datapath):
        ...
        self.drop_icmp_srcIP_srcPORT_dstIP(parser, t.dmz_service.get_ip_addr(), 22, '10.2.11.100', datapath)
        self.drop_tcp_srcIP_srcPORT_dstIP(parser, t.dmz_service.get_ip_addr(), 22, '10.2.11.100', datapath)
