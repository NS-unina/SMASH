...
sudo ./my-ovs-docker add-port br0_lan1 eth1 controller c1 20 --ipaddress=10.2.5.100/24
sudo ovs-vsctl -- set port c1_l tag=3
sudo iptables -t nat -A POSTROUTING -o c1_l -j MASQUERADE
sudo ./my-ovs-docker add-port br1_lan1 eth2 controller c2 21 --ipaddress=10.2.11.100/24
...
sudo ./my-ovs-docker add-port br0_lan1 eth1 int_host h1 15 --ipaddress=10.2.3.10/24 --macaddress=08:00:27:b6:d0:66
...
sudo ./my-ovs-docker add-port br0_lan1 eth1 int_ssh_server h3 16 --ipaddress=10.2.3.13/24 --macaddress=08:00:27:b6:d0:69
...
sudo ./my-ovs-docker add-port br1_lan1 eth1 ssh_server s1 22 --ipaddress=10.2.10.21/24 --macaddress=08:00:27:b6:d0:67
...
sudo ./my-ovs-docker add-port br1_lan1 eth1 ext_host h2 23 --ipaddress=10.2.10.22/24 --macaddress=08:00:27:b6:d0:68
...
sudo ./my-ovs-docker add-port br0_lan1 eth1 heralding t1 14 --ipaddress=10.2.3.21/24 --macaddress=08:00:27:b6:d0:6c
